...
public class Challenges {
    ...
    @Column(name = "challenge_image_url_index", length = 255, nullable = false)
    private String challengeImageUrlIndex;

    // Constructors
    public Challenges() {
    }

    public Challenges(String challengeName, String challengeDescription, String challengeImageUrl, String challengeImageUrlIndex) {
        this.challengeName = challengeName;
        this.challengeDescription = challengeDescription;
        this.challengeImageUrl = challengeImageUrl;
        this.challengeImageUrlIndex = challengeImageUrlIndex;
    }
    ...
    public String getChallengeImageUrlIndex() {
        return challengeImageUrlIndex;
    }

    public void setChallengeImageUrlIndex(String challengeImageUrlIndex) {
        this.challengeImageUrlIndex = challengeImageUrlIndex;
    }
