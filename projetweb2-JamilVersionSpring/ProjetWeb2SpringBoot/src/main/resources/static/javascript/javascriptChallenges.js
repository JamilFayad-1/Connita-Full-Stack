...
const setTableNames = ["first_set_complete", "second_set_complete", "third_set_complete"];
...
function loadChallengeSet(questions) {
    var questionLan = questions[0].question.toString();
...
function showScore() {
    ...
    if (score === currentQuestions.length) {
        $.ajax({
            url: '/updateChallengeRow',
            method: 'GET',
            data: { column_name: currentSetTableName,
